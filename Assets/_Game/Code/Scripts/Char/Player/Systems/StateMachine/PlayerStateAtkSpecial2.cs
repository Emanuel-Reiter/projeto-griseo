...
public class PlayerStateAtkSpecial2 : PlayerBaseState
{
    ...
    public override void UpdateState(PlayerStateManager manager)
    {
        ...
        if (GetCurrentTime() > GetStateCompletion(0.667f) && atkInput && manager.Deps.Attributes.CurrentMana >= manager.Deps.Equipment.EquipedSpecialSpell2.ManaCost) _queueAttack = true;
