...
public abstract class NpcBaseState : MonoBehaviour {
    ...
    public abstract void CheckExitState(NpcStateManager manager);
    public abstract void EnterState(NpcStateManager manager);
    public abstract void UpdateState(NpcStateManager manager);
    public abstract void PhysicsUpdateState(NpcStateManager manager);
    public abstract void ExitState(NpcStateManager manager);
